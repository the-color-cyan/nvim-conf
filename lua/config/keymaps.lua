...
map("t", "<C-A-Up>", "<cmd>resize +2<cr>", { desc = "Increase Window Height" })
map("t", "<C-A-Down>", "<cmd>resize -2<cr>", { desc = "Decrease Window Height" })
map("t", "<C-A-Left>", "<cmd>vertical resize -2<cr>", { desc = "Decrease Window Width" })
map("t", "<C-A-Right>", "<cmd>vertical resize +2<cr>", { desc = "Increase Window Width" })
